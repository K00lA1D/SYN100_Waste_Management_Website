...
const spreadsheetId = '1_oJBUJol8Lz1am5Beejy0FZoywtaCEkXCH33191YkO8';
const range = 'Form Responses 1!A1:L900';
const apiKey = 'AIzaSyCw8V9gPofljAaQV6UO_HeTbGRVK3jNrvk'; 
//This is the API Key that I (Sid Nair) used, and may or may not work by the time you are seing this
...
const Relevance = () => {
    ...
    const getSurveyData = async () => {
        ...
        if (values) {
            ...
            const labels = values[0].slice(1); 
            const data = values.slice(1).map(row => row.slice(1)); 
